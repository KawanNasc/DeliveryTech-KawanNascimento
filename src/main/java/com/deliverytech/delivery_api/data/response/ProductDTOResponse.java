...
@Schema(description = "Data for product response")
public class ProductDTOResponse {

    @Schema(description = "Product's unique identifier", example = "1")
    ...
    @Schema(description = "Restaurant associated with the product")
    @NotNull(message = "Restaurante é obrigatório")
    private RestaurantDTOResponse restaurant;
    ...
    public RestaurantDTOResponse getRestaurant() { return restaurant; }
    public void setRestaurant(RestaurantDTOResponse restaurant) { this.restaurant = restaurant; }
}