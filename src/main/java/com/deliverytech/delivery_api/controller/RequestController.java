...
public class RequestController {
        ...
        // Criar novo pedido
        @PostMapping
        @Operation(summary = "Create request", description = "Creates a new request in the system")
        @ApiResponses({
        ...
        public ResponseEntity<ApiResponseWrapper<RequestDTOResponse>> createRequest(
                        @Valid @RequestBody @Parameter(description = "Data of the request to be created") RequestDTORequest dto) {
        ...
        public ResponseEntity<ApiResponseWrapper<CalculateRequestDTOResponse>> calculateTotal(
                        @Valid @RequestBody @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Items for calculation") CalculateRequestDTORequest dto) {
                CalculateRequestDTOResponse calculation = requestServiceInt.calculateTotalRequest(dto);
                ApiResponseWrapper<CalculateRequestDTOResponse> response = new ApiResponseWrapper<>(true, calculation,
        ...
        @GetMapping
        @Operation(summary = "List requests", description = "Lists requests with optional filters and pagination")
        @ApiResponses({
        ...
        public ResponseEntity<PagedResponseWrapper<RequestDTOResponse>> list(
                ...
                Page<RequestDTOResponse> requests = requestServiceInt.listRequest(startDate, endDate, pageable);
                PagedResponseWrapper<RequestDTOResponse> response = new PagedResponseWrapper<>(requests);
                return ResponseEntity.ok(response);
        ...
        // Buscar pedido p/ ID
        @GetMapping("/{id}")
        @Operation(summary = "Find request by ID", description = "Retrieves a specific request with all details")
        @ApiResponses({
        ...
        @Operation(summary = "Update request status", description = "Updates the status of an request")
        @ApiResponses({
