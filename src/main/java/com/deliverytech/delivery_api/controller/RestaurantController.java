...
public class RestaurantController {
        ...
        // @PostMapping
        // @Operation(summary = "Register restaurant", description = "Create a new
        // restaurant in the system")
        // @ApiResponses({
        // @ApiResponse(responseCode = "201", description = "Restaurant created with
        // success"),
        // @ApiResponse(responseCode = "400", description = "Invalid data"),
        // @ApiResponse(responseCode = "409", description = "Restaurant exists")
        // })
        ...
        // @Valid @RequestBody
        // @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Creating
        // restaurant data") RestaurantDTORequest dto) {
        // RestaurantDTOResponse restaurant = restaurantServiceInt.register(dto);
        // ApiResponseWrapper<RestaurantDTOResponse> response = new
        // ApiResponseWrapper<>(true, restaurant,
        // "Restaurant created with success");
        // return ResponseEntity.status(HttpStatus.CREATED).body(response);
        // }

        // @GetMapping
        // @Operation(summary = "List restaurants", description = "List restaurants with
        // optional filters and pagination")
        // @ApiResponses({
        // @ApiResponse(responseCode = "200", description = "Listed with success")
        // })
        // public ResponseEntity<PagedResponseWrapper<RestaurantDTOResponse>>
        // listRestaurants(
        // @Parameter(description = "Restaurant category") @RequestParam(required =
        // false) String category,
        // @Parameter(description = "Pagination parameters") Pageable pageable) {
        // Page<RestaurantDTOResponse> restaurants =
        // restaurantServiceInt.listActive(category, pageable);
        // PagedResponseWrapper<RestaurantDTOResponse> response = new
        // PagedResponseWrapper<>(restaurants);
        // return ResponseEntity.ok(response);
        // }

        // @GetMapping("/{id}")
        // @Operation(summary = "Find restaurant by ID", description = "Retrieves a
        ...
        // RestaurantDTOResponse restaurant =
        // restaurantServiceInt.findRestaurantById(id);
        // ApiResponseWrapper<RestaurantDTOResponse> response = new
        // ApiResponseWrapper<>(true, restaurant,
        // "Restaurant found");
        // return ResponseEntity.ok(response);
        ...
        // @Operation(summary = "Find by category", description = "Lists restaurants of
        // a specific category")
        // @ApiResponses({
        // @ApiResponse(responseCode = "200", description = "Restaurants found")
        // })
        // public ResponseEntity<ApiResponseWrapper<List<RestaurantDTOResponse>>>
        // findByCategory(
        // @Parameter(description = "Restaurant category") @PathVariable String
        // category) {
        // List<RestaurantDTOResponse> restaurants =
        // restaurantServiceInt.findRestaurantsByCategory(category);
        // ApiResponseWrapper<List<RestaurantDTOResponse>> response = new
        // ApiResponseWrapper<>(true, restaurants,
        // "Restaurants found");
        // return ResponseEntity.ok(response);
        // }

        // @GetMapping("/{id}/delivery-fee/{zip}")
        // @Operation(summary = "Calculate delivery fee", description = "Calculates the
        // delivery fee for a specific ZIP code")
        // @ApiResponses({
        ...
        // @Operation(summary = "Nearby restaurants", description = "Lists restaurants
        // nearby a ZIP code")
        // @ApiResponses({
        ...
        // @Parameter(description = "Radius in km") @RequestParam(defaultValue = "10")
        // Integer radius) {
        // List<RestaurantDTOResponse> restaurants =
        // restaurantServiceInt.findNearbyRestaurants(zip, radius);
        // ApiResponseWrapper<List<RestaurantDTOResponse>> response = new
        // ApiResponseWrapper<>(true, restaurants,
        ...
        // @Operation(summary = "Restaurant products", description = "Lists all products
        // of a restaurant")
        // @ApiResponses({
        ...
        // @Parameter(description = "Filter only available") @RequestParam(required =
        // false) Boolean available) {
        // List<ProductDTOResponse> products =
        // productServiceInt.findProductsByRestaurant(restaurantId, available);
        ...
        // @PutMapping("/{id}")
        // @Operation(summary = "Update restaurant", description = "Updates the data of
        ...
        // RestaurantDTOResponse restaurant = restaurantServiceInt.updateRestaurant(id,
        // dto);
        // ApiResponseWrapper<RestaurantDTOResponse> response = new
        // ApiResponseWrapper<>(true, restaurant,
        ...
        // @Operation(summary = "Activate/Deactivate restaurant", description = "Toggles
        // the active/inactive status of the restaurant")
        // @ApiResponses({
        // @ApiResponse(responseCode = "200", description = "Status changed
        // successfully"),
        // @ApiResponse(responseCode = "404", description = "Restaurant not found")
        // })
        // public ResponseEntity<ApiResponseWrapper<RestaurantDTOResponse>>
        // changeStatus(
        // @Parameter(description = "Restaurant ID") @PathVariable Long id) {
        // RestaurantDTOResponse restaurant =
        // restaurantServiceInt.changeRestaurantStatus(id);
        // ApiResponseWrapper<RestaurantDTOResponse> response = new
        // ApiResponseWrapper<>(true, restaurant,
